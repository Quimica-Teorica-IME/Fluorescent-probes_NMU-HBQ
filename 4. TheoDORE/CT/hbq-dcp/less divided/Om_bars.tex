...
\addlegendentry{CTAC};
\addplot[ybar, draw=black, fill=cyan] table[x index=0, y index=6] {Om_bar_data.txt};
\addlegendentry{CTBA};
\addplot[ybar, draw=black, fill=red] table[x index=0, y index=7] {Om_bar_data.txt};
\addlegendentry{CTBC};
\addplot[ybar, draw=black, fill=gray] table[x index=0, y index=8] {Om_bar_data.txt};
\addlegendentry{CTCA};
\addplot[ybar, draw=black, fill=yellow] table[x index=0, y index=9] {Om_bar_data.txt};
\addlegendentry{CTCB};
\addplot[ybar, draw=black, fill=olive] table[x index=0, y index=10] {Om_bar_data.txt};
\addlegendentry{LEA};
\addplot[ybar, draw=black, fill=pink] table[x index=0, y index=11] {Om_bar_data.txt};
\addlegendentry{LEB};
\addplot[ybar, draw=black, fill=violet] table[x index=0, y index=12] {Om_bar_data.txt};
\addlegendentry{LEC};

% Uncomment for double excitations
% \addplot[ybar, draw=black, fill=yellow!50] table[x index=0, y index=13] {Om_bar_data.txt};
% \addlegendentry{2-el.};
% Handles for arrows

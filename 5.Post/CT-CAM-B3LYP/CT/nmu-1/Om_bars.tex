...
width=7.000 cm, height=3.0cm,xmin=0, xmax=4,
...
xtick={1, 1, 3},
xticklabels={$1(1)A$, $1(1)A$, $3(1)A$},
ymin=-0.0, ymax=1,
ybar stacked, bar width=1.556 cm]
...
\addlegendentry{CTBA};
\addplot[ybar, draw=black, fill=gray] table[x index=0, y index=7] {Om_bar_data.txt};
\addlegendentry{CTCA};
\addplot[ybar, draw=black, fill=red] table[x index=0, y index=8] {Om_bar_data.txt};
\addlegendentry{CTBC};
\addplot[ybar, draw=black, fill=Y] table[x index=0, y index=9] {Om_bar_data.txt};
\addlegendentry{CTCB};
\addplot[ybar, draw=black, fill=green] table[x index=0, y index=10] {Om_bar_data.txt};
\addlegendentry{LEA};
\addplot[ybar, draw=black, fill=orange] table[x index=0, y index=11] {Om_bar_data.txt};
\addlegendentry{LEB};
...
\node at (axis cs: 1,-0.15) (h2) {};
\node at (axis cs: 3,-0.15) (h3) {};
\end{axis}
